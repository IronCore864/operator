...
class _JujuContext:
    def __init__(self):
        ...
        self.env_vars = {key: os.environ.get(key) or '' for key in juju_env_vars}
...
class _Dispatcher:
    ...
    def _init_dispatch(self):
        ...
        in both cases.
        """
        self._dispatch_path = Path(self._juju_context.JUJU_DISPATCH_PATH)
...
class _Manager:
    ...
    def __init__(
        ...
        self._juju_context = _JujuContext()
    ...
    def _setup_root_logging(self):
        debug = 'JUJU_DEBUG' in self._juju_context
        ...
        handling_action = 'JUJU_ACTION_NAME' in self._juju_context
    ...
    def _make_framework(self, dispatcher: _Dispatcher):
        ...
        if self._juju_context.JUJU_DISPATCH_PATH.endswith('-relation-broken'):
